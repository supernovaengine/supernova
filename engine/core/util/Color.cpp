...
Vector3 Color::linearTosRGB(float r, float g, float b){
...
Vector4 Color::linearTosRGB(float r, float g, float b, float a){
...
Vector3 Color::sRGBToLinear(float r, float g, float b){
...
Vector4 Color::sRGBToLinear(float r, float g, float b, float a){
