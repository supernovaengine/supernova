...
void LuaBinding::registerObjectClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        ...
        .addFunction("setBillboard", (void(Mesh::*)(bool, bool, bool))&Mesh::setBillboard)
        .addProperty("billboard", &Mesh::isBillboard, (void(Mesh::*)(bool))&Mesh::setBillboard)
        .addProperty("fakeBillboard", &Mesh::isFakeBillboard, &Mesh::setFakeBillboard)
        .addProperty("cylindricalBillboard", &Mesh::isCylindricalBillboard, &Mesh::setCylindricalBillboard)
