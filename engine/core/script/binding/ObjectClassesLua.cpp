...
void LuaBinding::registerObjectClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        ...
        .addFunction("setAllowedAllMotion", &Body3D::setAllowedAllMotion)
        .addFunction("setAllowedOnlyTranslation", &Body3D::setAllowedOnlyTranslation)
        .addFunction("setAllowedOnlyRotation", &Body3D::setAllowedOnlyRotation)
        .addFunction("setAllowedOnly2DPlane", &Body3D::setAllowedOnly2DPlane)
        .addFunction("addAllowedTransactionX", &Body3D::addAllowedTransactionX)
        .addFunction("addAllowedTransactionY", &Body3D::addAllowedTransactionY)
        .addFunction("addAllowedTransactionZ", &Body3D::addAllowedTransactionZ)
        .addFunction("addAllowedRotationX", &Body3D::addAllowedRotationX)
        .addFunction("addAllowedRotationY", &Body3D::addAllowedRotationY)
        .addFunction("addAllowedRotationZ", &Body3D::addAllowedRotationZ)
