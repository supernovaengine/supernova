...
void LuaBinding::registerObjectClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        ...
        .addProperty("nearPlane",  &Camera::getNearPlane, &Camera::setNearPlane)
        .addProperty("farPlane",  &Camera::getFarPlane, &Camera::setFarPlane)
        .addProperty("leftPlane",  &Camera::getLeftPlane, &Camera::setLeftPlane)
        .addProperty("rightPlane",  &Camera::getRightPlane, &Camera::setRightPlane)
        .addProperty("bottomPlane",  &Camera::getBottomPlane, &Camera::setBottomPlane)
        .addProperty("topPlane",  &Camera::getTopPlane, &Camera::setTopPlane)
