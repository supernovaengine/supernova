...
void LuaBinding::registerECSClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleLifeInitializer>("PointParticleLifeInitializer")
        .addProperty("minLife", &PointParticleLifeInitializer::minLife)
        .addProperty("maxLife", &PointParticleLifeInitializer::maxLife)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticlePositionInitializer>("PointParticlePositionInitializer")
        .addProperty("minPosition", &PointParticlePositionInitializer::minPosition)
        .addProperty("maxPosition", &PointParticlePositionInitializer::maxPosition)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticlePositionModifier>("PointParticlePositionModifier")
        .addProperty("fromTime", &PointParticlePositionModifier::fromTime)
        .addProperty("toTime", &PointParticlePositionModifier::toTime)
        .addProperty("fromPosition", &PointParticlePositionModifier::fromPosition)
        .addProperty("toPosition", &PointParticlePositionModifier::toPosition)
        .addProperty("function", [] (PointParticlePositionModifier* self, lua_State* L) { return &self->function; }, [] (PointParticlePositionModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleVelocityInitializer>("PointParticleVelocityInitializer")
        .addProperty("minVelocity", &PointParticleVelocityInitializer::minVelocity)
        .addProperty("maxVelocity", &PointParticleVelocityInitializer::maxVelocity)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleVelocityModifier>("PointParticleVelocityModifier")
        .addProperty("fromTime", &PointParticleVelocityModifier::fromTime)
        .addProperty("toTime", &PointParticleVelocityModifier::toTime)
        .addProperty("fromVelocity", &PointParticleVelocityModifier::fromVelocity)
        .addProperty("toVelocity", &PointParticleVelocityModifier::toVelocity)
        .addProperty("function", [] (PointParticleVelocityModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleVelocityModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleAccelerationInitializer>("PointParticleAccelerationInitializer")
        .addProperty("minAcceleration", &PointParticleAccelerationInitializer::minAcceleration)
        .addProperty("maxAcceleration", &PointParticleAccelerationInitializer::maxAcceleration)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleAccelerationModifier>("PointParticleAccelerationModifier")
        .addProperty("fromTime", &PointParticleAccelerationModifier::fromTime)
        .addProperty("toTime", &PointParticleAccelerationModifier::toTime)
        .addProperty("fromAcceleration", &PointParticleAccelerationModifier::fromAcceleration)
        .addProperty("toAcceleration", &PointParticleAccelerationModifier::toAcceleration)
        .addProperty("function", [] (PointParticleAccelerationModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleAccelerationModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleColorInitializer>("PointParticleColorInitializer")
        .addProperty("minColor", &PointParticleColorInitializer::minColor)
        .addProperty("maxColor", &PointParticleColorInitializer::maxColor)
        .addProperty("useSRGB", &PointParticleColorInitializer::useSRGB)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleColorModifier>("PointParticleColorModifier")
        .addProperty("fromTime", &PointParticleColorModifier::fromTime)
        .addProperty("toTime", &PointParticleColorModifier::toTime)
        .addProperty("fromColor", &PointParticleColorModifier::fromColor)
        .addProperty("toColor", &PointParticleColorModifier::toColor)
        .addProperty("function", [] (PointParticleColorModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleColorModifier* self, lua_State* L) { self->function = L; })
        .addProperty("useSRGB", &PointParticleColorModifier::useSRGB)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleAlphaInitializer>("PointParticleAlphaInitializer")
        .addProperty("minAlpha", &PointParticleAlphaInitializer::minAlpha)
        .addProperty("maxAlpha", &PointParticleAlphaInitializer::maxAlpha)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleAlphaModifier>("PointParticleAlphaModifier")
        .addProperty("fromTime", &PointParticleAlphaModifier::fromTime)
        .addProperty("toTime", &PointParticleAlphaModifier::toTime)
        .addProperty("fromAlpha", &PointParticleAlphaModifier::fromAlpha)
        .addProperty("toAlpha", &PointParticleAlphaModifier::toAlpha)
        .addProperty("function", [] (PointParticleAlphaModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleAlphaModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleSizeInitializer>("PointParticleSizeInitializer")
        .addProperty("minSize", &PointParticleSizeInitializer::minSize)
        .addProperty("maxSize", &PointParticleSizeInitializer::maxSize)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleSizeModifier>("PointParticleSizeModifier")
        .addProperty("fromTime", &PointParticleSizeModifier::fromTime)
        .addProperty("toTime", &PointParticleSizeModifier::toTime)
        .addProperty("fromSize", &PointParticleSizeModifier::fromSize)
        .addProperty("toSize", &PointParticleSizeModifier::toSize)
        .addProperty("function", [] (PointParticleSizeModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleSizeModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleSpriteInitializer>("PointParticleSpriteInitializer")
        .addProperty("frames", &PointParticleSpriteInitializer::frames)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleSpriteModifier>("PointParticleSpriteModifier")
        .addProperty("fromTime", &PointParticleSpriteModifier::fromTime)
        .addProperty("toTime", &PointParticleSpriteModifier::toTime)
        .addProperty("frames", &PointParticleSpriteModifier::frames)
        .addProperty("function", [] (PointParticleSpriteModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleSpriteModifier* self, lua_State* L) { self->function = L; })
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleRotationInitializer>("PointParticleRotationInitializer")
        .addProperty("minRotation", &PointParticleRotationInitializer::minRotation)
        .addProperty("maxRotation", &PointParticleRotationInitializer::maxRotation)
        .endClass();

    luabridge::getGlobalNamespace(L)
        .beginClass<PointParticleRotationModifier>("PointParticleRotationModifier")
        .addProperty("fromTime", &PointParticleRotationModifier::fromTime)
        .addProperty("toTime", &PointParticleRotationModifier::toTime)
        .addProperty("fromRotation", &PointParticleRotationModifier::fromRotation)
        .addProperty("toRotation", &PointParticleRotationModifier::toRotation)
        .addProperty("function", [] (PointParticleRotationModifier* self, lua_State* L) { return &self->function; }, [] (PointParticleRotationModifier* self, lua_State* L) { self->function = L; })
        .endClass();
