...
bool SkyBox::load(){
    if (this->meshnodes[0]->getMaterial()->getTexture() == NULL)
        this->meshnodes[0]->getMaterial()->setTextureCube(textureFront, textureBack, textureLeft, textureRight, textureUp, textureDown);
