...
"  #ifdef HAS_SHADOWSCUBE\n"
"    bool checkShadowCube(vec3 vPosition, vec3 lightPos, samplerCube shadowMap, float cameraFarPlane, float cosTheta) {\n"
...
"        float lenToLight = length(fragToLight) / cameraFarPlane;\n"
...
"                   inShadow = checkShadowCube(v_Position, u_PointLightPos[i], u_shadowsMapCube[i], 50.0, PointLightcosTheta);\n"
"               }else{\n"
"                   for(int j = 0; j < MAXLIGHTS; ++j){\n"
"                       if (u_PointLightShadowIdx[i] == j){\n"
"                           inShadow = checkShadowCube(v_Position, u_PointLightPos[i], u_shadowsMapCube[j], 50.0, PointLightcosTheta);\n"
"                           break;\n"
"                       }\n"
"                   }\n"
"               }\n"
...
"        lightDistance = lightDistance / u_shadowCameraFar;\n"
