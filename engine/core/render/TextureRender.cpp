...
bool TextureRender::createShadowMapTexture(TextureType type, bool depth, int width, int height){
    return backend.createShadowMapTexture(type, depth, width, height);
}
