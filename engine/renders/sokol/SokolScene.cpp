...
void SokolScene::startFrameBuffer(FramebufferRender* framebuffer, size_t face){
    ...
    SokolCmdBuffer::add_command_begin_pass(pass, pass_action);
    //sg_begin_pass(pass, pass_action);
}

void SokolScene::startDefaultFrameBuffer(int width, int height){
    SokolCmdBuffer::add_command_begin_default_pass(pass_action, width, height);
    //sg_begin_default_pass(pass_action, width, height);
}

void SokolScene::applyViewport(Rect rect){
    SokolCmdBuffer::add_command_apply_viewport((int)rect.getX(), (int)rect.getY(), (int)rect.getWidth(), (int)rect.getHeight(), false);
...
void SokolScene::applyScissor(Rect rect){
    SokolCmdBuffer::add_command_apply_scissor_rect((int)rect.getX(), (int)rect.getY(), (int)rect.getWidth(), (int)rect.getHeight(), false);
...
void SokolScene::endFrameBuffer(){
    SokolCmdBuffer::add_command_end_pass();
    //sg_end_pass();
}
